...
- game_data_2025_match_results_add_7day_stats_K/  (出力)

このスクリプトを実行するコマンドは以下の通り
python add_window_7day_stats_K.py --output_dir game_data_2025_match_results_add_7day_stats_K game_data_2025_match_results
"""


"""
add_window_7day_stats.py の K% 版
