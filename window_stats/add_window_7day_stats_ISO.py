...
- game_data_2025_match_results_add_7day_stats_ISO/  (出力)

このスクリプトを実行するコマンドは以下の通り
python add_window_7day_stats_ISO.py --output_dir game_data_2025_match_results_add_7day_stats_ISO game_data_2025_match_results
"""

"""
add_window_7day_stats.py の ISO 版
