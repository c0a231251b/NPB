...
- game_data_2025_match_results_add_7day_stats_OBP/  (出力)

このスクリプトを実行するコマンドは以下の通り
python add_window_7day_stats_OBP.py --output_dir game_data_2025_match_results_add_7day_stats_OBP game_data_2025_match_results
"""
