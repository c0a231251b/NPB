...
- game_data_2025_match_results_add_30day_stats_OPS/  (出力)

このスクリプトを実行するコマンドは以下の通り
python add_window_30day_stats_OPS.py --output_dir game_data_2025_match_results_add_30day_stats_OPS game_data_2025_match_results
"""
    ...
    for i, (game_date, filepath, data) in enumerate(game_logs):
        ...
        for ab in at_bats:
            ...
            features.append({
                ...
                'batter_ops_30d': b_ops,
                'pitcher_ops_30d': p_ops,
