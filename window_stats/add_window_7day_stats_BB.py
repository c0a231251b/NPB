...
- game_data_2025_match_results_add_7day_stats_BB/  (出力)

このスクリプトを実行するコマンドは以下の通り
python add_window_7day_stats_BB.py --output_dir game_data_2025_match_results_add_7day_stats_BB game_data_2025_match_results
"""
