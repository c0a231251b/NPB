...
実行例:
python evaluate_lightgbm_fm_67_features_4class_so_out.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_67_features.csv"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_67_features_4class_so_out",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 67-feature CSV / 4-class SO_OUT target / no class_weight")
    print("=" * 80)
