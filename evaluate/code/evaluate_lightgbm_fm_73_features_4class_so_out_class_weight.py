# -*- coding: utf-8 -*-
"""
train_all_added_73_features.csv を用いて、提案3の4分類（SINGLE / XBH / BB_HBP / SO_OUT）で LightGBM と Factorization Machine(FM) を評価するスクリプト。
...
実行例:
python evaluate_lightgbm_fm_73_features_4class_so_out_class_weight.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_73_features.csv"
...
NON_OUT_NUMERIC_FEATURES = [
    "batter_non_out_rate",
    "pitcher_non_out_rate_allowed",
    "non_out_matchup_index",
    "vs_non_out_rate",
]
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv_path",
        type=str,
        default="data/train_all_added_73_features.csv",
        help="73特徴量を追加したCSVファイルパス",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_73_features_4class_so_out_class_weight",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 73-feature CSV / 4-class SO_OUT target / class_weight")
    print("=" * 80)
        ...
        json.dump(
            {
                ...
                "non_out_numeric_features": NON_OUT_NUMERIC_FEATURES,
                ...
                "added_from_69_features": NON_OUT_NUMERIC_FEATURES,
