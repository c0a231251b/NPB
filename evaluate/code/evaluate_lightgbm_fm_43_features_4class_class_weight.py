# -*- coding: utf-8 -*-
"""
train_all_added_43_features.csv を用いて LightGBM と Factorization Machine(FM) を同時に評価するスクリプト。

目的:
- 43特徴量版CSVを使い、HIT / BB_HBP / SO / OUT の4分類で評価する
...
- 比較結果を output_lgbm_fm_43_features_4class_class_weight/model_comparison_metrics.csv に保存する

実行例:
    python evaluate_lightgbm_fm_43_features_4class_class_weight.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_43_features.csv"
...
- previous_result1〜5 と base_out_state はカテゴリ特徴量として扱います。
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv_path",
        type=str,
        default="data/train_all_added_43_features.csv",
        help="43特徴量を追加したCSVファイルパス",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_43_features_4class_class_weight",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 43-feature CSV / 4-class target / class_weight")
    print("=" * 80)
