# -*- coding: utf-8 -*-
"""
train_all_added_67_features.csv を用いて、提案3の4分類（SINGLE / XBH / BB_HBP / SO_OUT）で LightGBM と Factorization Machine(FM) を評価するスクリプト。
...
実行例:
python evaluate_lightgbm_fm_67_features_4class_so_out_class_weight.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_67_features.csv"
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv_path",
        type=str,
        default="data/train_all_added_67_features.csv",
        help="67特徴量を追加したCSVファイルパス",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_67_features_4class_so_out_class_weight",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 67-feature CSV / 4-class SO_OUT target / class_weight")
    print("=" * 80)
