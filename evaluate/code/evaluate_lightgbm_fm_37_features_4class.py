...
- 比較結果を output_lgbm_fm_37_features_4class/model_comparison_metrics.csv に保存する

実行例:
    python evaluate_lightgbm_fm_37_features_4class.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_37_features.csv"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_37_features_4class",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 37-feature CSV / 4-class target")
    print("=" * 80)
