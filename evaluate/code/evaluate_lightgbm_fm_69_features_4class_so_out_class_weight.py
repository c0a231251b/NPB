...
実行例:
python evaluate_lightgbm_fm_69_features_4class_so_out_class_weight.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_69_features.csv"
...
INTERLEAGUE_LATE_NUMERIC_FEATURES = [
    "is_interleague",
    "season_progress",
]
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_69_features_4class_so_out_class_weight",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 69-feature CSV / 4-class SO_OUT target / class_weight")
    print("=" * 80)
        ...
        json.dump(
            {
                ...
                "interleague_late_numeric_features": INTERLEAGUE_LATE_NUMERIC_FEATURES,
                ...
                "added_from_67_features": INTERLEAGUE_LATE_NUMERIC_FEATURES,
