...
実行例:
python evaluate_lightgbm_fm_55_features.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_55_features.csv"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_55_features",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 55-feature CSV")
    print("=" * 80)
