...
目的:
- train_all_added_15_features.csv を用いる
...
実行例:
    python evaluate_lightgbm_fm_15_features.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_15_features.csv"

必要ライブラリ:
    pip install pandas numpy scikit-learn lightgbm torch tqdm

出力:
    output_lightgbm_fm_15_features/
...
# train_all_added_15_features.csv の数値特徴量
# 既存特徴量 + 追加した左右別8特徴量
NUMERIC_FEATURES = [
    "bat_order",
    "inning",
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv_path",
        type=str,
        default="data/train_all_added_15_features.csv",
        help="15特徴量追加済みCSV",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lightgbm_fm_15_features",
        help="出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("Class-weight comparison: LightGBM / FM with 15 features")
    print("=" * 80)
