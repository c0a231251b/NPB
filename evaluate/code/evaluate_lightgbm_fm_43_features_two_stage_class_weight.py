# -*- coding: utf-8 -*-
"""
train_all_added_43_features.csv を用いて、2段階分類で LightGBM と Factorization Machine(FM) を評価するスクリプト。
...
実行例:
    python evaluate_lightgbm_fm_43_features_two_stage_class_weight.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_43_features.csv"

必要ライブラリ:
    pip install pandas numpy scikit-learn lightgbm torch tqdm

出力:
- output_lgbm_fm_43_features_two_stage_class_weight/model_comparison_metrics.csv
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_43_features_two_stage_class_weight",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 43-feature CSV / two-stage target / class_weight")
    print("=" * 80)
