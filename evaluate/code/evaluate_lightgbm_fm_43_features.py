...
- 比較結果を output_lgbm_fm_43_features/model_comparison_metrics.csv に保存する

実行例:
python evaluate_lightgbm_fm_43_features.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate/data/train_all_added_43_features.csv"
...
- 既存特徴量 + 左右別成績8特徴量 + 直近成績9特徴量 + 試合状況3特徴量 + 累積率10特徴量 + イベント/場面6特徴量を扱います。37特徴量版に batter_hit_rate / batter_out_rate / pitcher_hit_rate_allowed / pitcher_out_rate / base_out_state / pitcher_bf_in_game を追加した43特徴量版です。
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_lgbm_fm_43_features",
        help="評価結果の出力先ディレクトリ",
    )
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for 43-feature CSV")
    print("=" * 80)
