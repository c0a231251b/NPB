...
class FactorizationMachineModel(nn.Module):
    def __init__(self, num_players, k=16, num_num_features=4): 
...
def train_fm_score_diff():
    ...
    dataset_file = "fm_dataset_score_diff_7d_30d.pkl" 
    ...
    joblib.dump(scaler, "fm_scaler_score_diff_7d_30d.gz") # スケーラーの保存名も変更
