...
# ==========================================
# 変更点: ファイル名および保存パスの一新
# スクリプト名: train_fm_model_score_diff_7d_30d.py
# ==========================================

class FactorizationMachineModel(nn.Module):
    def __init__(self, num_players, k=16, num_num_features=2): 
...
def train_fm_score_diff():
    ...
    dataset_file = "fm_dataset_score_diff_30d.pkl" 
    ...
    joblib.dump(scaler, "fm_scaler_score_diff_30d.gz") # スケーラーの保存名も変更
    ...
    output_model_path = "fm_model_score_diff_7d_30d.pth"
