...
- fm_dataset_7d.pkl
- fm_dataset_7d_OBP.pkl
- fm_dataset_7d_SLG.pkl
- fm_dataset_7d_OPS.pkl
- fm_dataset_7d_ISO.pkl
- fm_dataset_7d_K.pkl
- fm_dataset_7d_BB.pkl
- fm_dataset_7d_HR.pkl
"""
def train_fm():
    df = pd.read_pickle("fm_dataset_7d_HR.pkl")
    ...
    - fm_dataset_7d.pkl -> fm_scaler_7d.gz
    - fm_dataset_7d_OBP.pkl -> fm_scaler_7d_OBP.gz
    - fm_dataset_7d_SLG.pkl -> fm_scaler_7d_SLG.gz
    - fm_dataset_7d_OPS.pkl -> fm_scaler_7d_OPS.gz
    - fm_dataset_7d_ISO.pkl -> fm_scaler_7d_ISO.gz
    - fm_dataset_7d_K.pkl -> fm_scaler_7d_K.gz
    - fm_dataset_7d_BB.pkl -> fm_scaler_7d_BB.gz
    - fm_dataset_7d_HR.pkl -> fm_scaler_7d_HR.gz
    """

    scaler = StandardScaler()
    X_num = scaler.fit_transform(X_num)
    joblib.dump(scaler, "fm_scaler_7d_HR.gz")
    ...
    torch.save(model.state_dict(), "fm_model_7d_HR.pth")
    print("学習完了。 fm_model_7d_HR.pth を保存しました。")
