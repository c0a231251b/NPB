# -*- coding: utf-8 -*-
"""
LightGBM / Factorization Machine evaluation script for inning-level run prediction with 9 added features.
...
python evaluate_lightgbm_fm_inning_runs_added_9_features.py --csv_path "C:/Users/Admin/Desktop/NPB/evaluate_inning/data/train_inning_runs_added_9_features.csv"
...
Outputs:
  output_lgbm_fm_inning_runs_added_9_features/
...
# PyTorch is required when using the FM model.
# Import it directly so that VSCode/Pylance can resolve Dataset, DataLoader, and nn.Module
# as real types. If you only want to run LightGBM in an environment without PyTorch,
# use the original fallback-style script instead.
import torch
...
CATEGORICAL_FEATURES_BASE = [
    ...
    "starting_pitcher_id",
    "current_pitcher_id",
    # Added 9-feature version: batting-order group is categorical.
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="output_lgbm_fm_inning_runs_added_9_features")
    ...
    print("=" * 80)
    print("LightGBM / FM comparison for inning-level run prediction / added 9 features")
    print("=" * 80)
