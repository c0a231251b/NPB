#============================================================
# prepare_fm_dataset_7day_HR_contrast9.py
# HR% - 被HR%（7日間）の対比特徴量（contrast1〜contrast9）を
# そのまま LightGBM 用に出力するバージョン
# 出力：fm_dataset_7d_HR_contrast9.pkl
#============================================================
...
#============================================================
# メイン処理（7day HR contrast9）
#============================================================
def prepare_fm_dataset_7day_HR_contrast9():

    with open("player_id_master.json", "r", encoding="utf-8") as f:
        master = json.load(f)

    JSON_DIR = "game_data_2025_match_results_add_7day_stats_HR"
    ...
    print(f"--- 7day HR contrast9 データセット生成: {len(json_paths)}試合を処理中 ---")
    ...
    # 出力
    #============================================================
    pd.DataFrame(dataset).to_pickle("fm_dataset_7d_HR_contrast9.pkl")
    print("完了! 'fm_dataset_7d_HR_contrast9.pkl' を生成しました。")


if __name__ == "__main__":
    prepare_fm_dataset_7day_HR_contrast9()
