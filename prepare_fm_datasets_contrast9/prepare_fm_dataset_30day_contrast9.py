#============================================================
# prepare_fm_dataset_30day_contrast9.py
# 30日間の対比特徴量（contrast1〜contrast9）をそのまま出力する版
# 出力：fm_dataset_30d_contrast9.pkl
#============================================================
...
# メイン処理（30day 専用）
#============================================================
def prepare_fm_dataset_30day_contrast9():
    ...
    print(f"--- 30day contrast9 データセット生成: {len(json_paths)}試合を処理中 ---")
    ...
    for path in json_paths:
        ...
        #============================================================
        # 30day 対比特徴量（contrast1〜contrast9）
        #============================================================
    ...
    # 出力
    #============================================================
    pd.DataFrame(dataset).to_pickle("fm_dataset_30d_contrast9.pkl")
    print("完了! 'fm_dataset_30d_contrast9.pkl' を生成しました。")


if __name__ == "__main__":
    prepare_fm_dataset_30day_contrast9()
