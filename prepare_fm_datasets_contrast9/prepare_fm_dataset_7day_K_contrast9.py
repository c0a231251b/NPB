#============================================================
# prepare_fm_dataset_7day_K_contrast9.py
# K% - 被K%（7日間）の対比特徴量を
# contrast1〜contrast9 としてそのまま出力する版
# 出力：fm_dataset_7d_K_contrast9.pkl
#============================================================
...
# メイン処理（7day K% 専用）
#============================================================
def prepare_fm_dataset_7day_K_contrast9():

    with open("player_id_master.json", "r", encoding="utf-8") as f:
        master = json.load(f)

    JSON_DIR_7D = "game_data_2025_match_results_add_7day_stats_K"
    ...
    print(f"--- 7day K% contrast9 データセット生成: {len(json_paths)}試合を処理中 ---")
    ...
    for path in json_paths:
        ...
        #============================================================
        # 7day K% 対比特徴量（contrast1〜contrast9）
        #============================================================
    ...
    # 出力
    #============================================================
    pd.DataFrame(dataset).to_pickle("fm_dataset_7d_K_contrast9.pkl")
    print("完了! 'fm_dataset_7d_K_contrast9.pkl' を生成しました。")


if __name__ == "__main__":
    prepare_fm_dataset_7day_K_contrast9()
