#============================================================
# prepare_fm_dataset_30day_BB_contrast9.py
# 四球率 - 与四球率（30日間）の対比特徴量を
# contrast1〜contrast9 としてそのまま出力する版
# 出力：fm_dataset_30d_BB_contrast9.pkl
#============================================================
...
# メイン処理（30day BB% 専用）
#============================================================
def prepare_fm_dataset_30day_BB_contrast9():

    with open("player_id_master.json", "r", encoding="utf-8") as f:
        master = json.load(f)

    JSON_DIR_30D = "game_data_2025_match_results_add_30day_stats_BB"
    ...
    print(f"--- 30day BB% contrast9 データセット生成: {len(json_paths)}試合を処理中 ---")
    ...
    for path in json_paths:
        ...
        #============================================================
        # 30day BB% 対比特徴量（contrast1〜contrast9）
        #============================================================
    ...
    # 出力
    #============================================================
    pd.DataFrame(dataset).to_pickle("fm_dataset_30d_BB_contrast9.pkl")
    print("完了! 'fm_dataset_30d_BB_contrast9.pkl' を生成しました。")


if __name__ == "__main__":
    prepare_fm_dataset_30day_BB_contrast9()
