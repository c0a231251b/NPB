...
def run_game_count_analysis():
    ...
    cluster_file = "extracted_player_clusters_K3_score_diff.csv"  # K=3 の場合はこちら
    #cluster_file = "extracted_player_clusters_K4_score_diff.csv"  # K=4 の場合はこちら
    ...
    output_fig = f"cluster_real_game_count_heatmap_K{k_num}_score_diff.png"
